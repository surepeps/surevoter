...
class Pagination{
    ...
    var $nextLink       = '<li><a>Next Page<i class="icon-chevron-right"></i></a></li>';
    var $prevLink       = '<li><a><i class="icon-chevron-left"></i>Previous Page</a></li>';
    var $lastLink       = 'Last &rsaquo;';
    var $fullTagOpen    = '<div class="ps-pagination"><ul class="pagination">';
    var $fullTagClose   = '</div></ul>';
    var $firstTagOpen   = '';
    var $firstTagClose  = '&nbsp;';
    var $lastTagOpen    = '&nbsp;';
    var $lastTagClose   = '';
    ...
    function getAJAXlink( $count, $text) {
        if($this->link_func == '' && $this->contentDiv == '')
            return '<li class="active"><a  href="'.$this->baseURL.'?'.$count.'"'.$this->anchorClass.'>'.$text.'</a></li>';
        ...
        return "<li><a class=\"btn_1\" href=\"javascript:void(0);\" " . $this->anchorClass . " 
                ". $linkClick .">". $text .'</a></li>';
    }
}